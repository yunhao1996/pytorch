...
# 随机窗口采样
def generate_train_dataset(image_num = 900 ,
...
#     labels_path = ['dataset/origin/1_color.png','dataset/origin/2_color.png',
#                    'dataset/origin/3_color.png','dataset/origin/4_color.png']
    images_path = ['dataset/origin/5.png']
    labels_path = ['dataset/origin/5_color.png']
...
if __name__ == '__main__':
    if not os.path.exists('dataset/test/images'): os.mkdir('dataset/test/images')
    if not os.path.exists('dataset/test/labels'): os.mkdir('dataset/test/labels')
