...
parser.add_argument('--path', type=str, help='path to the dataset', default = '/home/cyh/视频/车辆识别/程序/datasets/train/')
parser.add_argument('--output', type=str, help='path to the file list' , default = '/home/cyh/视频/车辆识别/程序/datasets/test/')
